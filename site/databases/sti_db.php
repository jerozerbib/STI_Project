...
$res=$db->exec("CREATE TABLE CHAT (id INTEGER PRIMARY KEY, idsend INTEGER NOT NULL, idreceive INTEGER NOT NULL, subject TEXT NOT NULL, messages TEXT NOT NULL, read INTEGER NOT NULL,  Timestamp DATETIME DEFAULT CURRENT_TIMESTAMP);");
