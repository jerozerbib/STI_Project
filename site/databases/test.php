...
$res=$db->exec("CREATE TABLE CHAT (id INTEGER PRIMARY KEY, idsend INTEGER NOT NULL, idreceive INTEGER NOT NULL, topic TEXT NOT NULL, messages TEXT NOT NULL,  Timestamp DATETIME DEFAULT CURRENT_TIMESTAMP);");
...
$res=$db->exec("INSERT INTO USER"."(pseudo, passwd, validity, roles)"."VALUES ('marie', 'marie', '1' , 'low');");
